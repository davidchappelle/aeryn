...
/** \file iadd_tests.hpp
 *  \brief Interface for adding tests.
 */	

#ifndef AERYN_IADD_TESTS_HPP
#define AERYN_IADD_TESTS_HPP
...
{	
	/**	\brief Interface for adding tests. */
	class IAddTests : private Utils::Noncopyable
	{
	protected:
		/**	\brief Default constructor. 
		 *
		 *	Protected to for inheritance.
		 */
		IAddTests()
		{
		}
	...
	public:
		...
		virtual void Add
			...
			const TestCase nullTerminatedArray[] ) = 0;
		...
		virtual void Add
			( const std::string& name, 
			const TestCase& singleTestCase ) = 0;
