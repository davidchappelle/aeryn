...
{	
	...
	TestCase testFuncTests[] =
	{
		...
		TestCase( "IsEqualDelta( pass )", IsEqualDeltaTest ),
		TestCase( "IsEqualDelta( failure )", IsEqualDeltaFailTest ),
		TestCase( "IsNotEqualDelta( pass )", IsNotEqualDeltaTest ),
		TestCase( "IsNotEqualDelta( failure )", IsNotEqualDeltaFailTest ),
	...
	{
		TestCase( TestCase( USE_NAME( CommandLineParserTestDefaults ) ) ),
